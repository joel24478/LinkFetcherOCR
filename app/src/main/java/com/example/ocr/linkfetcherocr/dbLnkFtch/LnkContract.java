...
//
    ...
    /**
     * Inner class that defines constant values for the links database table.
     * Each entry in the table represents a single fetched data
     */
    public static final class LinkEntry implements BaseColumns {
        ...
        /* statics for completion
        public static final int validSearch = 0;
        public static final int invalidSearch = 1;
        */

        /** returns whether or not the scanned email is valid
         * */
